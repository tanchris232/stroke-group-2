...
def prod_model_generator(prod_df):
    ...
    steps2 = [("Scale", StandardScaler(with_mean=False)), 
    ...
    r2_value_ridge = r2_score(y_test, y_pred2)
    r2_adj_value_ridge = r2_adj(X_test, y_test, pipeline2)
    ...
    print(f"R-squared Ridge: {r2_value_ridge}")
    print(f"Adjusted R-squared Ridge: {r2_adj_value_ridge}")
    if r2_adj_value_ridge < 0.4:
        print("WARNING: LOW ADJUSTED R-SQUARED VALUE")
